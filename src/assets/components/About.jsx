...
const About = ()=>{
    return (
        <div className="abt">
            <div><h3 className="me">ABOUT ME <br /><p>Hi, I am Ismaheel Oladimeji, a fullstack software developer based in Lagos <br />and I have a background in Mathematics Education <br />
